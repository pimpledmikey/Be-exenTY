        ...
        <div className="card-actions d-flex">
          ...
          {entradasPagina.length > 0 && (
            <button 
              ...
              onClick={() => generarSolicitudEntrada(entradasPagina, entradasPagina[0]?.supplier)}
              title="Generar Solicitud de Autorización con estas entradas"
            >
