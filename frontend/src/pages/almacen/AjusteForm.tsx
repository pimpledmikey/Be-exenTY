...
const AjusteForm: React.FC<AjusteFormProps> = ({ onClose }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-3">
        <label className="form-label">Cantidad (puede ser negativa)</label>
      ...
      {success && <div className="alert alert-success mt-3">Ajuste guardado correctamente</div>}
